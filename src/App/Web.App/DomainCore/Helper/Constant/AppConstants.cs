namespace DomainCore.Helper.Constant
{
    public class AppConstants
    {
        ...
        public const string BalanceClient = "Balance";
        public const string TransactionClienct = "Transaction";

        public const string AuthenticationClient = "Authentication";

        public const long Requests = 0;
    ...
    {
        public const string BalanceNotification = "balance";
        public const string ResilienceeNotification = "resilience";
    }
}
...
public static class Extensions
{
    public static IServiceCollection AddCustomCap(this IServiceCollection services)
    {
        ...
        var dbOption = services.GetOptions<DatabaseConnection>("DBOption");
        
        services.AddCap(option =>
        {
            option.UseSqlite(dbOption.Connection);
            option.UseRabbitMQ(o =>
            {
            ...
            option.UseDashboard(opt => { opt.PathMatch = "/messageTrace"; });
            ...
            option.FailedThresholdCallback = failed =>
            {
                ...
                logger?.LogError(
                    $@"A message of type {failed.MessageType} failed after executing {option.FailedRetryCount} several times, 
       ...
       where TDbContext : DbContext
    {
        ...
        services.AddCap(x =>
        {
            ...
            x.UseDashboard(opt => { opt.PathMatch = "/messageTrace"; });

...
namespace BuildingBlocks.Logging.LinuxLog
{
	public class Syslog
	{
		[Flags]
		...
		public static class IdentityCOnst
		{
			...
			public static readonly string IdentityAPI = "IdentityAPI";
			public static readonly string BalanceAPI = "BalanceAPI";
			public static readonly string TransactionAPI = "TransactionAPI";
		}
